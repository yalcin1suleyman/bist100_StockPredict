...
# Veriyi oku
df = pd.read_csv('outputs/Table_5_3_DL_Performance_Scenarios.csv')
...
# Baslik
fig.suptitle('Tablo 5.2.1b. Derin Ogrenme Modellerinin Farkli Ozellik Senaryolarindaki Performanslari',
...
fig.text(0.5, 0.05,
         'Not: Derin ogrenme modelleri de Makine Ogrenmesi modelleri ile ayni senaryolarda egitilmistir.\n'
         'Makine ogrenmesine benzer sekilde, ham verilerde (Senaryo 1) performans belirgin sekilde duserken, teknik gostergelerle artmaktadir.',
...
output_path = os.path.join(output_dir, "Tablo_5_2_1_Derin_Ogrenme_Senaryo.png")
plt.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='white')
plt.close()

# Excel kaydet
excel_path = os.path.join(output_dir, "Tablo_5_2_1_Derin_Ogrenme_Senaryo.xlsx")
